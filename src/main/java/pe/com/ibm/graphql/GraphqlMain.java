...
public class GraphqlMain{
    ...
    ApplicationRunner init( ComidaService objComidaService, ClienteService objClienteService ){ 
    	...
    	return argumentos -> {   
	        ...
	        //GUARDANDO!: 
	        objComidaService.saveComida( objComida_01 );  
	        objComidaService.saveComida( objComida_02 );	 	
	        objComidaService.saveComida( objComida_03 );
	        
	        objClienteService.saveCliente( objCliente_01 );
	        objClienteService.saveCliente( objCliente_02 );
	        objClienteService.saveCliente( objCliente_03 );	        
		};
    }
